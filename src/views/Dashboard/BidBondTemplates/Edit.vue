...
<script>
    ...
    export default {
        ...
        methods: {
            fetch() {
                axios.get('/api/v1/bid-bond-templates/' + this.$route.params.id + '/edit').then(response => {
            ...
            submit() {
                ...
                axios.put('/api/v1/bid-bond-templates/' + this.$route.params.id, data).then(response =>{
